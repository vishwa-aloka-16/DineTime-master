<%@ page import="com.dinetime.dinetime.Handlers.StorageHandler" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="main">
        <div class="container">
            <div class="heading heading-center mb-3">
                <h2 class="title">Top Selling Restaurants</h2><!-- End .title -->
                    ...
                    <div class="products">
                        <div class="row justify-content-center">
                            ...
                            <%
                                ...
                                String[][] allRestaurants = handler.readAllLines();
                                ...
                                for(String[] restaurant: allRestaurants){
                                    ...
                                    String type =  restaurant[2];
                                    String image =  restaurant[3];
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                ...
                                <div class="product product-11 text-center">
                                    <figure class="product-media">
                                        <a href="viewRestaurant.jsp?name=<%= name %>" style="display: block; width: 100%; aspect-ratio: 1 / 1; overflow: hidden;">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp?name=<%= name %>"><%= name %></a></h3><!-- End .product-title -->
                                    </div><!-- End .product-body -->
                                    <div class="product-action">
                                        <a href="Reservation.jsp" class="btn-product">
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Garden Armchair</a></h3><!-- End .product-title -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">2-Seater</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $3.107,00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Wingback Chair</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $2.486,00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Madra Log Holder</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $401,00
                                        </div><!-- End .product-price -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Original Outdoor Beanbag</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $259,00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Cushion Set 3 Pieces</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $199,00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Petite Table Lamp</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $401,00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Carronade Large Suspension Lamp</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $401,00
                                        </div><!-- End .product-price -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="viewRestaurant.jsp">Carronade Table Lamp</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $499,00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                            ...
                            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                <form action="#">
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" id="register-name" name="register-name" required>
                                    </div><!-- End .form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="register-password-conform" name="register-password-conform" required>
                                    </div><!-- End .form-group -->

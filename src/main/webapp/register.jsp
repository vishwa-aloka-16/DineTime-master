                        ...
                        <div class="dropdown-menu">
                            <nav class="side-nav">
                                <ul class="menu-vertical sf-arrows">
                                    <li class="item-lead"><a href="#">Find A Restaurant</a></li>
                                ...
                                <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                    ...
                                    <form action="register-user" method="post">
                                        <div class="form-group">
                                            <label for="register-name">Your Display name *</label>
                                        ...
                                        <div class="form-group">
                                            <label for="register-accType">Your Account Type *</label>
                                            <select name="register-accType" class="form-control">
                                                <option value="1" class="form-control">Customer</option>
                                                <option value="2" class="form-control">Owner</option>
                                            </select>
                                        </div><!-- End .form-group -->
...
<!-- molla/login.jsp  22 Nov 2019 10:04:03 GMT -->
</html>
<%@ page import="com.dinetime.dinetime.Classes.Restaurant" %><%
    ...
    String resturentName = request.getParameter("name");
    Restaurant restaurant = new Restaurant(resturentName);
                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="<%= restaurant.getImageLink()%>" data-zoom-image="<%= restaurant.getImageLink()%>" alt="product image">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title"><%= restaurant.getName()%></h1><!-- End .product-title -->
                                    ...
                                    <div class="product-content">
                                        <p style="max-width: 100%; word-wrap: break-word; overflow-wrap: break-word;">
                                            <%= restaurant.getDescription() %>
                                        </p>
                                    </div><!-- End .product-content -->

                                    <div class="product-details-action">
                                        <a href="Reservation.jsp?r=<%= resturentName%>" class="btn-product btn-cart"><span>Book a Table Now</span></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <figure class="product-media">
                        <a href="viewRestaurant.jsp">
                            <img src="<%= restaurant.getImageLink()%>" alt="Product image">
                        </a>
                    </figure><!-- End .product-media -->
                    <h4 class="product-title"><a href="viewRestaurant.jsp"><%=restaurant.getName()%></a></h4><!-- End .product-title -->
                </div><!-- End .col-6 -->
                ...
                <div class="col-6 justify-content-end">
                    ...
                    <div class="product-details-action">
                        <a href="Reservation.jsp" class="btn-product btn-cart"><span>Book a table</span></a>
                    </div><!-- End .product-details-action -->
                </div><!-- End .col-6 -->
            </div><!-- End .row -->
        </div><!-- End .container -->
...
<!-- molla/ viewRestaurant.jsp  22 Nov 2019 09:55:05 GMT -->
</html>
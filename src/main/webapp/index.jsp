            ...
            <div class="container">
                <div class="header-left">
                    <%
                        ...
                        if (msg!=null){
                    %>
                    <p class="text-danger"><%=msg%>.</p><a href="#">&nbsp;Read more ...</a>
                    <%
                    }else{
                    %>
    ...
    <main class="main">
        <div class="intro-slider-container">
            <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{"nav": false}'>
                <div class="intro-slide" style="background-image: url(https://assets.architecturaldigest.in/photos/65e9631d9719efc62841b9d5/16:9/w_2560%2Cc_limit/DSC07703_11zon.jpg);">
                    <div class="container intro-content">
                        <h3 class="intro-subtitle">New restaurants</h3><!-- End .h3 intro-subtitle -->
                        <h1 class="intro-title">Find Restaurants <br>That Suits You.</h1><!-- End .intro-title -->

                        <a href="Restaurants.jsp" class="btn btn-primary" style="background-color:white; color: #1f1e18;">
                            <span>View Restaurants</span>
                            <i class="icon-long-arrow-right"></i>
                        </a>
                        <a href="Reservation.jsp" class="btn btn-primary" style="background-color:white; color: #1f1e18;">
                ...
                <div class="intro-slide" style="background-image: url(https://toohotel.com/wp-content/uploads/2022/09/TOO_restaurant_Panoramique_vue_Paris_nuit_v2-scaled.jpg);">
                    <div class="container intro-content">
                        <h3 class="intro-subtitle">Register yours</h3><!-- End .h3 intro-subtitle -->
                        <h1 class="intro-title">Are You An Owner? <br>Register Your Restaurant <br><span class="text-primary"><sup>Rs</sup>Free</span></h1><!-- End .intro-title -->
                ...
                <div class="intro-slide" style="background-image: url(assets/images/demos/demo-2/slider/slide-3.jpg);">
                    <div class="container intro-content">
                        <h3 class="intro-subtitle">Nearest Restaurant</h3><!-- End .h3 intro-subtitle -->
                        <h1 class="intro-title">
                            All At One Place <br>Find and Book A Table.<br>
                            <span class="text-primary">
                                    <sup class="text-white font-weight-light">for</sup><sup>Rs</sup> Free
                                </span>
                        </h1><!-- End .intro-title -->
        ...
        <div class="banner-group">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-5 h-50">
                        <div class="banner banner-large banner-overlay banner-overlay-light">
                            <a href="#">
                                <img style="height: 55vh; object-fit: cover;" src="https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjJ8fHJlc3RhdXJhbnR8ZW58MHx8MHx8fDA%3D" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-top ">
                                <h4 class="banner-subtitle" style="color: #e8e8e8;">Browse Now</h4><!-- End .banner-subtitle -->
                                <h3 class="banner-title" style="color: #e8e8e8;">Find Restaurants</h3><!-- End .banner-title -->
                                <div class="banner-text" style="color: #e8e8e8;">and reserve a table </div><!-- End .banner-text -->
                                <a href="Restaurants.jsp" class="btn btn-outline-gray banner-link" style="color: #e8e8e8;">Find Now<i class="icon-long-arrow-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="banner banner-overlay">
                            <a href="Restaurants.jsp">
                                <img style="height: 55vh; object-fit: cover;" src="https://img.freepik.com/premium-photo/cold-beer-with-classic-burgers-restaurant-wooden-table-delicious-food_482257-19738.jpg?semt=ais_hybrid&w=740" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-bottom">
                                <h4 class="banner-subtitle text-grey">On Sale</h4><!-- End .banner-subtitle -->
                                <h3 class="banner-title text-white">Amazing <br>Restaurants</h3><!-- End .banner-title -->
                                <div class="banner-text text-white">Book And Go</div><!-- End .banner-text -->
                                <a href="Restaurants.jsp" class="btn btn-outline-white banner-link">Discover Now<i class="icon-long-arrow-right"></i></a>
                            </div><!-- End .banner-content -->
                        </div><!-- End .banner -->
                    </div><!-- End .col-lg-3 -->
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-overlay">
                            <a href="Restaurants.jsp">
                                <img style="height: 25vh; object-fit: cover;" src="https://images.pexels.com/photos/1581384/pexels-photo-1581384.jpeg?cs=srgb&dl=pexels-reneterp-1581384.jpg&fm=jpg" alt="Banner">
                            </a>
                        ...
                        <div class="banner banner-overlay banner-overlay-light">
                            <a href="Restaurants.jsp">
                                <img style="height: 25vh; object-fit: cover;" src="https://assets.architecturaldigest.in/photos/64f84cc61d4896b633fba77a/master/w_1600%2Cc_limit/The%2520art%2520deco%2520inspired%2520de%25CC%2581cor%2520of%2520CIRQA%25201960%2520.jpg" alt="Banner">
                            </a>

                            <div class="banner-content banner-content-top">
                                <h4 class="banner-subtitle">On Sale</h4><!-- End .banner-subtitle -->
                                <h3 class="banner-title">New Restaurants</h3><!-- End .banner-title -->
                                <div class="banner-text">up to 30% off on bookings</div><!-- End .banner-text -->
                                <a href="Restaurants.jsp" class="btn btn-outline-gray banner-link">Book Now<i class="icon-long-arrow-right"></i></a>
                            </div><!-- End .banner-content -->
                        </div><!-- End .banner -->
                    </div><!-- End .col-lg-4 -->
                </div><!-- End .row -->
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                ...
                                <div class="product product-11 text-center">
                                    ...
                                    <div class="product-action">
                                        <a href="Reservation.jsp?r=<%= name%>" class="btn-product">

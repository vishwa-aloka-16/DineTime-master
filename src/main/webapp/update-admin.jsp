...
<div class="page-wrapper">
    ...
    <main class="main">
        <div class="page-content">
            <div class="container nt-5 mb-3 w-50 py-2">
                <h1 class="header-2 mt-5 text-center">Update Admin Details</h1>
                <h6 class="text-center mb-5"></h6>
                <form action="admin-update" method="post">
                    <div class="form-group">
                        <label >Email address *</label>
                        <input type="text" class="form-control" name="email" required value="<%= admin.getEmail()%>">
                    </div><!-- End .form-group -->

                    <div class="form-group">
                        <label >Name *</label>
                        <input type="text" class="form-control"  name="name" required value="<%= admin.getDisplayName()%>">
                    </div><!-- End .form-group -->

                    <div class="form-group">
                        <label >Password *</label>
                        <input type="password" class="form-control"  name="password" required value="<%= admin.getPassword()%>">
                    </div><!-- End .form-group -->

<%@ page import="com.dinetime.dinetime.Classes.Reservation" %>
<%@ page import="com.dinetime.dinetime.Classes.Restaurant" %>
<%@ page import="com.dinetime.dinetime.Classes.Table" %>
<%@ page import="com.dinetime.dinetime.Classes.Customer" %>
<!DOCTYPE html>
<html lang="en">
<%
...
<div class="page-wrapper">
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Restaurant name<span>sub text</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        ...
        <div class="page-content">
            <div class="container mb-5">
                <h1 class="header-2 text-center">Your Reservations</h1>
                <h6 class="text-center mb-5">View Your pending Reservations</h6>
                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col" class="col-1">#</th>
                        <th scope="col" class="col-1">Table</th>
                        <th scope="col" class="col-4">Email</th>
                        <th scope="col" class="col-1">Seat Count</th>
                    ...
                    <tbody>
                    <%
                        Reservation[] reservations = restaurant.getAllReservation();
                        System.out.println("reserevation"+reservations.length);
                        int i = 0;

                        for (Reservation reservation : reservations){
                            i++;
                            if (reservation.getTableID().equals("-99"))
                                continue;
                            %>
                    <tr>
                        <td><%= i %></td>
                        <td><%= reservation.getTableID() %></td>
                        <td><%= reservation.getCustomerEmail() %></td>
                        <td><%= reservation.getReservationSeats() %></td>
                        <td><%= reservation.getReservationDateTime().split("T")[0]%></td>
                        <td><%= reservation.getReservationDateTime().split("T")[1]%></td>
                        <td>
                            <form action="complete-reservation" method="post">
                                <input type="hidden" name="tableId" value="<%= reservation.getTableID() %>">
                                <input type="hidden" name="restaurant" value="<%= reservation.getRestaurentName() %>">
            ...
            <div class="container mt-5">
                ...
                <h1 class="header-2 text-center">Your Tables</h1>
                <h6 class="text-center mb-5">Add New Tables to the reservation list.</h6>
        <!--
            Register Table
        -->
                <form action="register-table" method="post" class="col justify-content-center py-5 px-2 w-50 mx-auto bg-light border-dark rounded-3 my-5">
                    <h5 class="form-group text-center">Add or Update tables here</h5>
                    <div class="form-group col-5 mx-auto">
                        <label class="form">Restaurant</label>
                        <input name="name" type="text" class="form-control" readonly value="${param.name}">
                    </div>
                    <div class="form-group col-5 mx-auto">
                        <label class="form">Table ID *</label>
                        <input name="id" type="text" class="form-control">
                    </div>
                    <div class="form-group col-5 mx-auto">
                        <label class="form">Table Seats *</label>
                        <input name="seats" type="number" class="form-control">
                    </div>
                    <div class="form-group col-5 mx-auto my-5 d-flex align-items-end mx-auto">
                        <button class="btn btn-outline-primary w-100">+ Table</button>
                    </div>
                </form>

                <table class="table w-80 mx-auto text-center">
                    <thead>
                    <tr>
                        <th scope="col" class="col-1">Table Id</th>
                        <th scope="col" class="col-1">No Seats</th>
    ...
    <footer class="footer footer-2">
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="footer-copyright">Copyright © 2019 Dine Time Store. All Rights Reserved.</p><!-- End .footer-copyright -->

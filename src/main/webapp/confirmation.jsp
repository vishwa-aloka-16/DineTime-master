    ...
    <div class="container">
        ...
        <%
            ...
            if (status.equals("p")){
                ...
                String time = request.getParameter("date").split("T")[1] ;
                String date = request.getParameter("date").split("T")[0];
                %>
        <div class="cta cta-horizontal cta-horizontal-box bg-image mb-3" style="background-image: url(assets/images/backgrounds/cta/bg-1.jpg); background-position: center right;">
            <div class="align-items-center text-center">
                <div class="col-lg-4 col-xl-3 offset-xl-1 mx-auto">
                    <h2 class="title text-center">Enjoy Your Meal!</h2><!-- End .title -->
                    <h3 class="title text-center">Your Table <br> <h3 style="font-size: 8rem"> <%=id%></h3></h3><!-- End .title -->
                    <a href="dashboardCustomer.jsp" class="btn btn-outline-dark btn-round" style="color: #0b2e13"><span>View Your Reservations</span><i class="icon-long-arrow-right"></i></a>
                    <h5 class="banner-subtitle text-left mt-3 bg-white rounded border p-4">
                        Restaurant: <%= name%> <br>
                        Table: ID_<%= id%> <br>
                        Time: <%= time%> <br>
                        Date: <%= date%> <br>
        ...
        <div class="cta cta-horizontal cta-horizontal-box bg-image mb-5" style="background-image: url(assets/images/backgrounds/cta/bg-1.jpg); background-position: center right;">
            <div class="align-items-center text-center">
                <div class="col-lg-4 col-xl-3 offset-xl-1 mx-auto">
                    <h2 class="title text-center">No Available Tables Please Try Later!</h2><!-- End .title -->
                    <p class="cta-desc mb-1">Feel free to use Dine Time again!</p><!-- End .cta-desc -->
                    <a href="#" class="btn btn-outline-dark btn-round" style="color: #0b2e13"><span>View Your Reservations</span><i class="icon-long-arrow-right"></i></a>
                </div><!-- End .col-xl-3 -->
            </div><!-- End .row -->
        </div><!-- End .cta -->
        <%
